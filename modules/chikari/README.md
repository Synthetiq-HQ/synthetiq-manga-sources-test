...
descriptors. No app rebuild or account is needed. Install through the Books test
catalogue: https://raw.githubusercontent.com/Synthetiq-HQ/synthetiq-manga-sources-test/main/index.json.
...
node scripts/validate-test-repo.mjs
```
